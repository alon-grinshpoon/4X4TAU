...
public class RecordComposite extends Composite {
	...
	public void createContents() {
		...
		String fileRecord = Utils.PACKAGE_PATH + Utils.getSkin() + "/Record.png";
		...
		String fileForward = Utils.PACKAGE_PATH + Utils.getSkin() + "/Forward.png";
		...
		String fileBackwards = Utils.PACKAGE_PATH + Utils.getSkin() + "/Backwards.png";
		InputStream resourceBackwards = FavoritesComposite.class.getClassLoader()
				.getResourceAsStream(fileBackwards);
		final Image imgBackwards = new Image(this.getDisplay(), resourceBackwards);
